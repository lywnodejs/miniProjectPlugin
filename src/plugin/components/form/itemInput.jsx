...
export default function ItemInput({label,maxlength, placeholder, type = 'text', name, value, required = true,disabled = false}) {
    ...
    return (
        <View className="input_con">
            ...
            <View className={`input ${disabled && 'disabled'}`}>
                <Input maxlength={maxlength} disabled={disabled} ref={inputRef} name={name} type={type} placeholder={placeholder} />
            </View>
        </View>
    )
}